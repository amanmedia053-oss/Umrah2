...
const BottomNav = ({ activeTab, setActiveTab }: { activeTab: string, setActiveTab: (t: string) => void }) => {
  ...
  return (
    <nav className={`fixed bottom-0 left-0 right-0 h-16 flex items-center justify-around border-t z-40
...
const HomeScreen = () => {
  ...
  return (
    <div className="pb-20">
      <div className={`p-6 rounded-b-[40px] relative overflow-hidden mb-6
        ${getAccentClass(accentColor)}`}>
    ...
    <div className="px-6 pt-12 pb-20">
      ...
      <div className={`p-6 rounded-3xl mb-8 leading-relaxed text-justify
        ...
        <p className="font-bold text-center mt-6">
          ...
          مرسته کوونکي:الحاج ډاکټر فريدون څ
